/**
  ...
  *          in user code.
  *          Updated with Motor Safety Test & Error Handling v2.0
  ******************************************************************************
  */
#include "app.h"
...
void App_Init(void)
{
    ...
    /* 7) Bluetooth bridge (also arms UART RX) - UPDATED with safety parameter */
    BtMotor_Init(&g_bt, &g_motor, &g_motor_safety, &huart1);
